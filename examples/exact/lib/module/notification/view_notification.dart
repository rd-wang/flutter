    ...
    return ListView(
      ...
      children: <Widget>[
        ...
        Wrap(alignment: WrapAlignment.center, children: <Widget>[
          ...
          PermissionIndicator(
              name: 'Vibrations', allowed: controller.scheduleChannelPermissions[NotificationPermission.Vibration]!),
          PermissionIndicator(
        ...
        SimpleButton('Open Schedule channel\'s permission page',
            ...
            onPressed: () =>
                NotificationUtils.redirectToScheduledChannelsPage().then((_) => controller.refreshPermissionsIcons())),
        ...
        SimpleButton('Open Precise Alarm\'s permission page',
            enabled: !Platform.isIOS,
            onPressed: () => NotificationUtils.redirectToAlarmPage().then((_) => controller.refreshPermissionsIcons())),
        ...
        SimpleButton('Show the most basic notification', onPressed: () => NotificationUtils.showBasicNotification(1)),
        ...
        SimpleButton('Send background notification', onPressed: () => NotificationUtils.sendBackgroundNotification(1)),
        ...
        SimpleButton('Show large icon notification', onPressed: () => NotificationUtils.showLargeIconNotification(2)),
        ...
        SimpleButton('Show media player', onPressed: () => Get.toNamed(Routes.mediaDetail)),
        SimpleButton('Cancel notification',
            backgroundColor: Colors.red,
            labelColor: Colors.white,
        ...
        const SimpleButton('Cancel all notifications and schedules',
            backgroundColor: Colors.red, labelColor: Colors.white, onPressed: NotificationUtils.cancelAllNotifications),
      ],
    );
  }
}
