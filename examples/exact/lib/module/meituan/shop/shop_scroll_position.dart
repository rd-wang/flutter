...
/// 滑动位置信息
class ShopScrollPosition extends ScrollPosition implements ScrollActivityDelegate {
  ShopScrollPosition({
  ...
  @override
  bool applyContentDimensions(double minScrollExtent, double maxScrollExtent, [bool fromCoordinator = false]) {
    if (debugLabel == coordinator.pageLabel && !fromCoordinator)
      return coordinator.applyContentDimensions(minScrollExtent, maxScrollExtent, this);
