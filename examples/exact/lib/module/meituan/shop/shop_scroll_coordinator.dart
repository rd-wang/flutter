...
class ShopScrollCoordinator {
  ...
  bool applyContentDimensions(double minScrollExtent, double maxScrollExtent, ShopScrollPosition position) {
  ...
  void onPointerUp(PointerUpEvent event) {
    ...
    if (0.0 < _pagePixels && _pagePixels < _pageInitialOffset!) {
      if (pageExpand == PageExpandState.NotExpand && _pageInitialOffset! - _pagePixels > _scrollRedundancy) {
        _pageScrollPosition
            .animateTo(
              0.0,
